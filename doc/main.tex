...
\texttt{--wrf\_dir}, \texttt{--wrf\_input\_file}, \texttt{--wrf\_bdy\_file},
\texttt{--wrf\_met\_dir}, \texttt{--wrf\_met\_files}, \texttt{--mera\_dir},
\texttt{--mera\_files}, \texttt{--do\_IC=true|false}, and
\texttt{--do\_BC=true|false}. Use ``python \textit{main.py} --help'' to print all options.
...
``python \textit{main.py} --wrf\_dir /path/to/wrf/run --wrf\_met\_dir /path/to/wps/run --mera\_dir /path/to/merra --do\_IC=true --do\_BC=true''.
